...
description: Deploying ONF Aether-in-a-Box for private 4G/5G edge cloud testing
...
toc: true
toc_sticky: true
image: /assets/images/posts/2022-03-25-aiab/0.png
image_link: https://opennetworking.org/aether/
---
...
The ROC GUI is available on port 31194 on the host running AiaB.
 ...
 - Dashboard
    ![Aether ROC GUI dashboard](/assets/images/posts/2022-03-25-aiab/01.png)

 - Alert view
    ![Aether ROC GUI alert view](/assets/images/posts/2022-03-25-aiab/02.png)

 - Slice view
    ![Aether ROC GUI slice view](/assets/images/posts/2022-03-25-aiab/03.png)

 - User plane function view
    ![Aether ROC GUI user plane function view](/assets/images/posts/2022-03-25-aiab/04.png)

 - Device groups view
    ![Aether ROC GUI device groups view](/assets/images/posts/2022-03-25-aiab/05.png)

 - Devices view
    ![Aether ROC GUI devices view](/assets/images/posts/2022-03-25-aiab/06.png)

 - SIM cards view
    ![Aether ROC GUI SIM cards view](/assets/images/posts/2022-03-25-aiab/07.png)

 - Sites view
    ![Aether ROC GUI sites view](/assets/images/posts/2022-03-25-aiab/08.png)

 - Small cells view
    ![Aether ROC GUI small cells view](/assets/images/posts/2022-03-25-aiab/09.png)

 - Traffic classes view
    ![Aether ROC GUI traffic classes view](/assets/images/posts/2022-03-25-aiab/10.png)

 - IP domains view
    ![Aether ROC GUI IP domains view](/assets/images/posts/2022-03-25-aiab/11.png)

 - Enterprises view
    ![Aether ROC GUI enterprises view](/assets/images/posts/2022-03-25-aiab/12.png)

 - Connectivity services view
    ![Aether ROC GUI connectivity services view](/assets/images/posts/2022-03-25-aiab/13.png)
